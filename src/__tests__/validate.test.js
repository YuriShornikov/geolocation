...
describe('testing validate geolocation', () => {
  ...
  test('error by correct numbers', () => {
    ...
    expect(() => validateCoordinates(',6117.89')).toThrow('Введите корректные координаты.');
  });

  test('return geolocation', () => {
    expect(validateCoordinates('12.345, 67.890')).toEqual({ latitude: 12.345, longitude: 67.890 });
    expect(validateCoordinates('  89.012,34.567  ')).toEqual({ latitude: 89.012, longitude: 34.567 });
  });
});
